...
export const Header = function ({ navigation, text, goto, picture, account} : Props): JSX.Element {
  return (
    <NativeBaseProvider>
      <View style={header_style.container}>
          <HStack>
              <Button style={header_style.button1} onPress={() => navigation.navigate(goto)}>
                  <Image
              ...
              <Button style={header_style.button2} onPress={() => navigation.navigate("RegistrationScreen")}>
                  <Image
