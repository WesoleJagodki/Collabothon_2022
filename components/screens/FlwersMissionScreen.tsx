...
export const FlowersMissionScreen = function ({ navigation }: any): JSX.Element {
  return (
      <NativeBaseProvider>
              ...
              >
                  <VStack style={tickets_screen_style.vstack1}>
                      <TouchableOpacity onPress={() => navigation.navigate(QuestScreen)}>
                          <Image source={require("../../images/header-2.png")} style={tickets_screen_style.picture1} alt="Orientarium ZOO Łódź"></Image>
                      </TouchableOpacity>
                  </VStack>
              </Header>
              <ScrollView style={flowers_mission_screen_style.test}>
                  <View style={flowers_mission_screen_style.view1}>
                      <Badge shadow={4} rounded={20} style={quest_inside_screen_style.badge}>
                          ...
                          />
                          <Text style={flowers_mission_screen_style.text2}>Helianthus (Helianthus annuus)</Text>
                          <View style={flowers_mission_screen_style.view2}>
                              <Image source={require("../../images/quest-inside-screen-7.png")} alt="Orientarium ZOO Łódź"></Image>
                          ...
                          >
                              <Text style={flowers_mission_screen_style.text4}>Lern more</Text>
                          </Button>
                      </Badge>
                      <Badge shadow={4} rounded={20} style={quest_inside_screen_style.badge}>
                          <Image
                              ...
                              alt="Orientarium ZOO Łódź"
                          />
                          <Text style={flowers_mission_screen_style.text2}>Tuplips                  (Tulipa)</Text>
                          <View style={flowers_mission_screen_style.view2}>
                              <Image source={require("../../images/quest-inside-screen-7.png")} alt="Orientarium ZOO Łódź"></Image>
                              <Text style={flowers_mission_screen_style.text2}>10</Text>
                          </View>
                  ...
                  <View style={flowers_mission_screen_style.view3}>
                      <Badge shadow={4} rounded={20} style={flowers_mission_screen_style.badge}>
                          <Image
                              ...
                              alt="Orientarium ZOO Łódź"
                          />
                          <Text style={flowers_mission_screen_style.text2}>Daisy (Bellis perennis)</Text>
                      ...
                      <Badge shadow={4} rounded={20} style={flowers_mission_screen_style.badge}>
                          <Image
                              ...
                              alt="Orientarium ZOO Łódź"
                          />
                          <Text style={flowers_mission_screen_style.text2}>Rose (Rosa rubiginosa)</Text>
