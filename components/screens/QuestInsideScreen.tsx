      ...
      <NativeBaseProvider>
          <View style={global_style.container}>
              ...
              <HStack space={10} style={quest_inside_screen_style.hstack}>
                  ...
                  <Button rounded={20} colorScheme={"orange"}>Inside</Button>
              </HStack>
              <ScrollView style={quest_inside_screen_style.test}>
                  <View style={quest_inside_screen_style.view1}>
                      <Badge shadow={4} rounded={20} style={quest_inside_screen_style.badge}>
                          ...
                          />
                          <Text style={quest_inside_screen_style.text2}>Giant otter (Pteronura brasiliensis)</Text>
                      ...
                      <Badge shadow={4} rounded={20} style={quest_inside_screen_style.badge}>
                          <Image
                              ...
                              alt="Orientarium ZOO Łódź"
                          />
                          <Text style={quest_inside_screen_style.text2}>Java mouse-deer (Trangulus javanicus)</Text>
                  ...
                  <View style={quest_inside_screen_style.view1}>
                      <Badge shadow={4} rounded={20} style={quest_inside_screen_style.badge}>
                          <Image
                              ...
                              alt="Orientarium ZOO Łódź"
                          />
                          <Text style={quest_inside_screen_style.text2}>Kirk's dik-dik (Madoqua kirkii)</Text>
