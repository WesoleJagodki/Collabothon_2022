    ...
    <NativeBaseProvider>
      <View style={global_style.container}>
        ...
        <HStack space={10} style={quest_screen_style.hstack}>
          ...
          <Button
            onPress={() => navigation.navigate("QuestInsideScreen")}
            rounded={20}
            backgroundColor={0}
          >
            <Text>Inside</Text>
        ...
        <ScrollView style={quest_screen_style.test}>
          <TouchableOpacity
            style={quest_screen_style.touchable}
            onPress={() => navigation.navigate("FlowersMissionScreen")}
          >
            <Badge shadow={4} rounded={20} style={quest_screen_style.badge}>
              ...
              <Text style={quest_screen_style.text3}>
                Collect all the flower pictures to get points
              </Text>
            </Badge>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <Badge shadow={4} rounded={20} style={quest_screen_style.badge}>
              ...
              <Text style={quest_screen_style.text3}>
                Collect all the trees pictures to get points
              </Text>
            </Badge>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <Badge shadow={4} rounded={20} style={quest_screen_style.badge}>
              ...
              <Text style={quest_screen_style.text3}>
                Answer the questions to get points
              </Text>
            </Badge>
          </TouchableOpacity>
        </ScrollView>
