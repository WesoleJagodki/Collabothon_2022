...
export const FooterItem = function ({
  navigation,
  page,
  isSelected,
  text,
  ...
  return (
    <Button
      onPress={() => navigation.navigate(targets[`footer${page}`])}
      style={footer_style.button}
    >
      <Image
      ...
      />
      <Text style={isSelected ? footer_style.text : footer_style.text1}>
        {text}
      </Text>
    </Button>
  );
